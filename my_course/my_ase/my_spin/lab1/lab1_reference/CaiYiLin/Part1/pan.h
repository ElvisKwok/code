...
#define nstates1	24	/* fork_proc */
#define minseq1	36
#define maxseq1	58
#define endstate1	23

#define nstates0	37	/* phil */
#define minseq0	0
#define maxseq0	35
#define endstate0	36
...
#define Pfork_proc	((P1 *)this)
typedef struct P1 { /* fork_proc */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, req) - 1*sizeof(int))
...
#define Air0	(sizeof(P0) - Offsetof(P0, fork_right) - 1*sizeof(int))
